...
<details class="rec-inventory"><summary>Alle Erkennungsversionen herunterladen <span class="rec-inv-count">(2 Versionen)</span></summary><table class="rec-inv-table"><thead><tr><th>Engine</th><th>Modell</th><th>Zeichen</th><th>Status</th><th>Konfidenz</th><th>Download</th></tr></thead><tbody><tr class="rec-inv-page-header"><th colspan="6">Nicht zugeordnet</th></tr><tr><td class="rec-inv-cell">fusion</td><td class="rec-inv-cell">—</td><td class="rec-inv-cell">—</td><td class="rec-inv-cell"><span class="rec-status rec-status--erfolgreich">Erfolgreich</span></td><td class="rec-inv-cell rec-inv-note">Nicht angegeben</td><td class="rec-inv-cell rec-inv-dl"><a href="recognitions/fused.txt" download>fused.txt</a></td></tr><tr><td class="rec-inv-cell">kraken</td><td class="rec-inv-cell">k0</td><td class="rec-inv-cell">—</td><td class="rec-inv-cell"><span class="rec-status rec-status--erfolgreich">Erfolgreich</span></td><td class="rec-inv-cell rec-inv-note">80%</td><td class="rec-inv-cell rec-inv-dl"><a href="recognitions/kraken-k0.txt" download>kraken-k0.txt</a></td></tr></tbody></table></details>
