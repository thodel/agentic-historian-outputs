...
<div class="recognition-viewer" data-recognition-viewer>
<nav class="recognition-selector" aria-label="Erkennungsergebnis auswählen"><p><strong>Erkennungsergebnis:</strong></p><ul><li><a href="#recognition-selected" data-recognition-select="selected" aria-controls="recognition-selected">Ausgewählt / Fusion</a> <span class="selected-badge">Ausgewählt</span> <span class="recognition-status">Erfolgreich</span></li><li><a href="#recognition-kraken-k0" data-recognition-select="kraken-k0" aria-controls="recognition-kraken-k0">kraken · k0</a> <span class="recognition-status">Erfolgreich</span></li></ul></nav>
<div class="recognition-panels"><details class="recognition-panel" id="recognition-selected" data-recognition-panel="selected" data-page="" open>
...
--- p2.jpg ---
gut lesbar hier</code></pre><p class="recognition-download"><a href="recognitions/fused.txt">Diese Transkription herunterladen</a></p></details><details class="recognition-panel" id="recognition-kraken-k0" data-recognition-panel="kraken-k0" data-page="">
...
<pre class="transcription" tabindex="0"><code>gut lesbar hier</code></pre><p class="recognition-download"><a href="recognitions/kraken-k0.txt">Diese Transkription herunterladen</a></p></details></div></div>
<script src="{{ '/assets/recognitions.js' | relative_url }}" defer></script></section>
