...
<div class="rec-viewer" data-recognition-viewer data-doc-id="order-ens" data-recognition-download-switcher>
<div class="rec-primary-download"><a class="btn-rec-download" href="recognitions/fused.txt" data-doc-id="order-ens" data-default-href="recognitions/fused.txt" download data-rec-primary-download>Aktuelle Transkription herunterladen <span class="rec-download-format">TXT</span></a><span class="rec-download-provenance">fusion · Seite nicht zugeordnet</span></div><div class="dl-switcher"><label for="dl-cand-select-order-ens">Andere Version wählen:</label> <select id="dl-cand-select-order-ens" class="dl-cand-select" data-doc-id="order-ens"><option value="selected" data-href="recognitions/fused.txt">Ausgewählt / Fusion</option>
<option value="kraken-k0" data-href="recognitions/kraken-k0.txt">Kraken OCR · k0</option></select></div>
...
<div><dt>Seite</dt><dd>Nicht zugeordnet</dd></div>
<div><dt>Engine-Konfidenz</dt><dd aria-label="Engine-Konfidenz: 80%, Einheit: Wahrscheinlichkeit, Geltungsbereich: kraken/k0"><span class="rec-confidence-value">80%</span> <span class="rec-confidence-scope">— kraken/k0</span> <button class="quality-explain-btn" type="button" aria-expanded="false" aria-controls="quality-explanation-engine_confidence"><span aria-hidden="true">ⓘ</span> Engine-Konfidenz</button></dd></div><details class="rec-confidence-raw"><summary>Rohtext</summary><p>Engine: kraken</p><p>Modell: k0</p><p>Seite: Nicht zugeordnet</p><p>Konfidenz: 0.8</p></details>
...
<p><a class="rec-download" href="recognitions/kraken-k0.txt" download data-cand="kraken-k0">Diese Transkription herunterladen</a></p>
</details></div>
</div></section>
