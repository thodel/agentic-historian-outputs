...
<div class="transcription-toolbar"><button type="button" class="copy-btn" data-copy-transcript aria-label="Transkription in die Zwischenablage kopieren"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="9" y="9" width="13" height="13" rx="2" ry="2"></rect><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"></path></svg>Transkription kopieren</button></div><div class="transcription-wrap" role="table" aria-label="Transkription mit Zeilennummern"><span class="line" data-line="1" role="row"><span class="line-number" aria-hidden="true">1</span><span class="line-text">--- page_1.jpg ---</span></span><span class="line" data-line="2" role="row"><span class="line-number" aria-hidden="true">2</span><span class="line-text">page page_1.jpg</span></span><span class="line" data-line="3" role="row"><span class="line-number" aria-hidden="true">3</span><span class="line-text"> </span></span><span class="line" data-line="4" role="row"><span class="line-number" aria-hidden="true">4</span><span class="line-text">--- page_2.jpg ---</span></span><span class="line" data-line="5" role="row"><span class="line-number" aria-hidden="true">5</span><span class="line-text">page page_2.jpg</span></span></div>
</section>
...
<div class="rec-viewer" data-recognition-viewer data-doc-id="epic2-test-doc" data-recognition-download-switcher>
...
<div class="table-scroll"><table class="rec-inv-table"><thead><tr><th>Engine</th><th>Modell</th><th>Typ</th><th>Seite</th><th>Zeichen</th><th>Status</th><th>Konfidenz/Fehler</th><th>Download</th></tr></thead><tbody><tr class="rec-inv-page-header"><th colspan="7">Nicht zugeordnet</th></tr><tr><td>fusion</td><td class="inv-model"><code>—</code></td><td><span class="badge badge--raw">roh · S. </span></td><td class="inv-right">Seite </td><td class="inv-right">70</td><td>Erfolgreich</td><td>Nicht angegeben</td><td class="rec-inv-dl"><a href="recognitions/fused.txt" download>fused.txt</a></td></tr><tr><td>kraken</td><td class="inv-model"><code>epic2-verification</code></td><td><span class="badge badge--raw">roh · S. </span></td><td class="inv-right">Seite </td><td class="inv-right">31</td><td>Erfolgreich</td><td>90%</td><td class="rec-inv-dl"><a href="recognitions/kraken-epic2-verification.txt" download>kraken-epic2-verification.txt</a></td></tr></tbody></table></div></details>
...
<select class="rec-compare-select" id="rec-compare-select-left" data-rec-compare-select="left"><option value="selected" data-page="">Ausgewählt / Fusion</option><option value="kraken-epic2-verification" data-page="">Kraken OCR · epic2-verification</option></select>
<div class="rec-compare-body" data-rec-compare-body="left" tabindex="-1" aria-live="polite"></div></div>
<div class="rec-compare-pane" data-rec-compare-pane="right" data-rec-compare-selected="kraken-epic2-verification">
<div class="rec-compare-header"><label class="rec-compare-label" for="rec-compare-select-right">Version rechts</label></div>
<select class="rec-compare-select" id="rec-compare-select-right" data-rec-compare-select="right"><option value="selected" data-page="">Ausgewählt / Fusion</option><option value="kraken-epic2-verification" data-page="">Kraken OCR · epic2-verification</option></select>
...
<nav class="rec-selector" aria-label="Erkennungsversionen"><ul><li><a href="#recognition-selected" data-recognition-select="selected" data-page="" data-engine="fusion" data-model="" aria-controls="recognition-selected">Ausgewählt / Fusion</a> <span class="rec-status rec-status--ok">Erfolgreich</span></li><li><a href="#recognition-kraken-epic2-verification" data-recognition-select="kraken-epic2-verification" data-page="" data-engine="kraken" data-model="epic2-verification" aria-controls="recognition-kraken-epic2-verification">Kraken OCR · epic2-verification</a> <span class="rec-status rec-status--ok">Erfolgreich</span></li></ul></nav>
...
<div><dt>Zeichen</dt><dd>70</dd></div>
...
--- page_2.jpg ---
page page_2.jpg</code></pre>

<p><span class="rec-download-unavailable">Kein Textdownload verfügbar</span></p>
</details><details class="rec-panel" id="recognition-kraken-epic2-verification" data-recognition-panel="kraken-epic2-verification" data-page="" data-engine="kraken" data-model="epic2-verification">
<summary>Kraken OCR · epic2-verification</summary>
<dl class="rec-meta">
<div><dt>Engine</dt><dd>kraken</dd></div>
<div><dt>Modell</dt><dd>epic2-verification</dd></div>
<div><dt>Seite</dt><dd>Nicht zugeordnet</dd></div>
<div><dt>Engine-Konfidenz</dt><dd aria-label="Engine-Konfidenz: 90%, Einheit: Wahrscheinlichkeit, Geltungsbereich: kraken/epic2-verification"><span class="rec-confidence-value">90%</span> <span class="rec-confidence-scope">— kraken/epic2-verification</span> <button class="quality-explain-btn" type="button" aria-expanded="false" aria-controls="quality-explanation-engine_confidence"><span aria-hidden="true">ⓘ</span> Engine-Konfidenz</button></dd></div><details class="rec-confidence-raw"><summary>Rohtext</summary><p>Engine: kraken</p><p>Modell: epic2-verification</p><p>Seite: Nicht zugeordnet</p><p>Konfidenz: 0.9</p></details>
<div><dt>Zeichen</dt><dd>31</dd></div>
...
<pre class="rec-text" tabindex="0"><code>page page_1.jpg
page page_2.jpg</code></pre>
...
<h3>PERSON</h3><ul><li><a href="../entities/test-person-b60f38b4/">Test Person</a> <span class="entity-noise-flag" title="lange Konsonantenfolge; nur einmal erkannt">Unsichere Erkennung · Score 2</span></li></ul>
...
<ul><li><a href="epic2-test-doc-recognition-package.zip">Vollständiges Erkennungspaket (ZIP)</a></li><li><a href="transcription.tei.xml">TEI-XML</a></li><li><a href="entities.csv">Entitäten (CSV)</a></li><li><a href="pipeline.json">Vollständige Pipeline-Ausgabe (JSON)</a></li><li><a href="CITATION.cff">CITATION.cff</a></li></ul>
...
<p><code>Agentic Historian. (2026). Agentic Historian output: epic2-test-doc [Machine-generated dataset]. https://thodel.github.io/agentic-historian-outputs/epic2-test-doc/</code></p>
<p>Stabile Seite: <a href="https://thodel.github.io/agentic-historian-outputs/epic2-test-doc/">https://thodel.github.io/agentic-historian-outputs/epic2-test-doc/</a> · <a href="https://github.com/thodel/agentic-historian-outputs/commits/main/docs/epic2-test-doc/pipeline.json">Versionsverlauf auf GitHub</a></p></section>
</details>
...
<script type="application/ld+json">{
  ...
  "@type": "Dataset",
  "name": "Agentic Historian output: epic2-test-doc",
  "url": "https://thodel.github.io/agentic-historian-outputs/epic2-test-doc/",
  "creator": {
  ...
  "distribution": [
    {
      "@type": "DataDownload",
      "name": "Pipeline JSON",
      "contentUrl": "https://thodel.github.io/agentic-historian-outputs/epic2-test-doc/pipeline.json",
      "encodingFormat": "application/json"
    },
    {
      "@type": "DataDownload",
      "name": "TEI-XML Transkription",
      "contentUrl": "https://thodel.github.io/agentic-historian-outputs/epic2-test-doc/transcription.tei.xml",
      "encodingFormat": "application/tei+xml"
    },
    {
      "@type": "DataDownload",
      "name": "Entitäten (CSV)",
      "contentUrl": "https://thodel.github.io/agentic-historian-outputs/epic2-test-doc/entities.csv",
      "encodingFormat": "text/csv"
    },
    {
      "@type": "DataDownload",
      "name": "CITATION.cff",
      "contentUrl": "https://thodel.github.io/agentic-historian-outputs/epic2-test-doc/CITATION.cff",
