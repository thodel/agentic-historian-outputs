...
<nav class="breadcrumbs"><a href="../">Entitäten</a> / bischof</nav><h1>bischof</h1><p><span class="entity-type">ROLE</span> · 1 Vorkommen</p><p><strong>Belegte Schreibvarianten:</strong> <code>Bischof</code>, <code>bischof</code></p><div class="notice notice--warning entity-noise-notice"><strong>Unsichere Erkennung.</strong> Heuristischer Score 2: lange Konsonantenfolge, nur einmal erkannt. Dieser Eintrag bleibt zur Nachvollziehbarkeit vollständig erhalten.</div><p class="notice notice--warning">Nicht mit einem externen Normdatensatz verknüpft.</p><div class="table-scroll"><table><thead><tr><th>Ausgabe</th><th>Form</th><th>Kontext</th><th>Konfidenz</th></tr></thead><tbody><tr><td><a href="../../u-17__/">u-17__</a></td><td>Bischof</td><td>Bischof</td><td>Nicht angegeben</td></tr></tbody></table></div>