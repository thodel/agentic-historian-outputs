...
<nav class="breadcrumbs" aria-label="Brotkrumen"><a href="../">Alle Ausgaben</a> <span aria-hidden="true">/</span> saa-0005-test</nav>
<header class="output-header page-section page-section--identity" data-page-section="identity">
  <p class="output-kicker">Testlauf</p><h1>saa-0005-test</h1>
...
<script type="application/ld+json">{
  ...
  "@type": "Dataset",
  "name": "Agentic Historian output: saa-0005-test",
  "url": "https://thodel.github.io/agentic-historian-outputs/saa-0005-test/",
  "creator": {
  ...
  "distribution": [
    {
      "@type": "DataDownload",
      "name": "Pipeline JSON",
      "contentUrl": "https://thodel.github.io/agentic-historian-outputs/saa-0005-test/pipeline.json",
      "encodingFormat": "application/json"
    },
    {
      "@type": "DataDownload",
      "name": "TEI-XML Transkription",
      "contentUrl": "https://thodel.github.io/agentic-historian-outputs/saa-0005-test/transcription.tei.xml",
      "encodingFormat": "application/tei+xml"
    },
    {
      "@type": "DataDownload",
      "name": "Entitäten (CSV)",
      "contentUrl": "https://thodel.github.io/agentic-historian-outputs/saa-0005-test/entities.csv",
      "encodingFormat": "text/csv"
    },
    {
      "@type": "DataDownload",
      "name": "CITATION.cff",
      "contentUrl": "https://thodel.github.io/agentic-historian-outputs/saa-0005-test/CITATION.cff",
      "encodingFormat": "text/x-yaml"
    }
  ],
  "description": "Gerichtsbrief",
  "isBasedOn": "https://my.override.com/page/42"
}</script>
