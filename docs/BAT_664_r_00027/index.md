...
| Feld | Wert |
|---|---|
| Datierung | 27. Juni 1429 |
| Sprache | Mittelniederdeutsch / schweizerdeutsch, gemischt mit kursive lateinische Elemente (z.B. in der Datierung). |
| Schrift | Gotische schwarze Kurrentschrift, verwendet Abkürzungen wie 'vn' für 'und', 'dn' oder 'd[n]' für 'dem', 'i' für 'in', 'vn' für 'von'. Tinte ist schwarz, Rubrizierungen fehlen. |
